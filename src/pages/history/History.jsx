                                    ...
                                    <li key={index}>
                                        <div className="titles margin row between align-center">
                                            ...
                                            <span className='count'>
                                                {
                                                    (() => {
                                                        const total = i?.transactions.reduce((acc, tx) => {
                                                            const amount = Number(tx.amount)
                                                            return tx.program ? acc + amount : acc - amount
                                                        }, 0)

                                                        const sign = total > 0 ? '+ ' : total < 0 ? '− ' : ''
                                                        return sign + Math.abs(total).toLocaleString('ru-RU') + ' uzs'
                                                    })()
                                                }
                                            </span>
                                        </div>
