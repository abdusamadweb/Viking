            ...
            <div className="container p0">
                ...
                <div className="swap__body">
                    ...
                    <div className="mb2">
                        ...
                        <p className="desc">
                            <span><Tr val='Минимальная сумма пополнения составляет 5 000 сум' />.</span> <span className="opacity"><Tr val='Пополнения на сумму меньше не принимаются и автоматически отклоняются системой' />.</span>
                        </p>
                    </div>
                    <div>
                        <p className="sub-title"><Tr val='Вывод средств' /></p>
                        <p className="desc">
                            <span><Tr val='Минимальная сумма вывода средств составляет 9 999 999 сум' />.</span> <span className="opacity"><Tr val='Запросы на меньшие суммы не обрабатываются' />.</span>
                        </p>
                    </div>
                </div>
            </div>
